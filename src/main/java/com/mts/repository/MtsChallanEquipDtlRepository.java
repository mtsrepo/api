...
//	        + "    mcd.mtsChallanId = :mtsChallanId", nativeQuery = true)
	...
	@Query(value = "SELECT \r\n"
			...
			+ "    consign_add.GSTN AS consigno.GSTN,\r\n"
			+ "    consigne_add.GSTN AS consigne.GSTN\r\n"
			+ "FROM \r\n"
			+ "    mts_challan_document mcd\r\n"
			+ "LEFT JOIN \r\n"
			+ "    mts_location_master fromAddress \r\n"
			+ "    ON mcd.despFrmLocationMasterId = fromAddress.mtsLocationMasterId\r\n"
			+ "LEFT JOIN \r\n"
			+ "    mts_location_master toAddress \r\n"
			...
			+ "    ON mcd.consigneeId = consignee.mtsPartyMasterId\r\n"
			+ "LEFT JOIN \r\n"
			+ "    mts_party_address consigne_add \r\n"
